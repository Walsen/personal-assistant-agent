# 02 - Agente con acceso a Google Workspace

Este paso agrega autenticación con Google (Gmail, Calendar y Docs) al agente.
...
Renombra el archivo descargado a `credentials.json` y colócalo en la raíz de este proyecto (`02-agente-email-conf/credentials.json`).
