...
Este paso construye sobre la autenticación de Google del paso anterior y expone
Gmail, Calendar y Docs como herramientas (`@tool`) que el agente puede invocar.
...
Renombra el archivo descargado a `credentials.json` y colócalo en la raíz de este proyecto (`03-agente-impl-tools/credentials.json`).
